jQuery(document).ready(function($) {
    ...
    function toggle_methods() {
        ...
        if (calc_method === 'C' || calc_method === 'CI') {
            ...
            $('#jigoshop_shippingcalc_prod_lot_size').closest('tr').fadeIn();
            ...
            $('#jigoshop_shippingcalc_prod_lot_size').closest('tr').fadeOut();
            ...
            $('#jigoshop_shippingcalc_prod_lot_size').closest('tr').hide();
